...
const playlists = [
  {
    ...
    tracks: 8,
    image:
      "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=150&q=80",
  },
  {
    id: 2,
    ...
    tracks: 12,
    image:
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=150&q=80",
  },
  {
    id: 3,
    ...
    tracks: 15,
    image:
      "https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=150&q=80",
  },
  {
    id: 4,
    title: "Data Science",
    tracks: 10,
    image:
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=150&q=80",
  },
];
...
const tracks = [
  {
    ...
    duration: "24:35",
    image:
      "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=60&h=60&q=80",
  },
  {
    id: 2,
    ...
    duration: "18:22",
    image:
      "https://images.unsplash.com/photo-1614728263952-84ea256f9679?ixlib=rb-4.0.3&auto=format&fit=crop&w=60&h=60&q=80",
  },
  {
    id: 3,
    ...
    duration: "32:10",
    image:
      "https://images.unsplash.com/photo-1581093196277-9f6e9b96cc00?ixlib=rb-4.0.3&auto=format&fit=crop&w=60&h=60&q=80",
  },
  {
    id: 4,
    title: "Future Directions in Quantum Computing",
    author: "Quantum Future",
    duration: "41:05",
    image:
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=60&h=60&q=80",
  },
];
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 space-y-4 sm:space-y-0">
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Player</h1>
      </div>

      {/* Main player section with sidebars */}
      <div className="flex">
        {/* Left sidebar with tools */}
        <div className="w-16 bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-6 hidden md:flex">
        ...
        <div className="flex-1 bg-white">
          <div className="relative">
            {/* Main visualization image - Updated with online URL */}
            <div className="w-full bg-black">
              <Image
                src="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&h=400&q=80"
            ...
            <div className="absolute top-4 left-4 bg-white rounded-md p-2 shadow-md">
              <div className="text-xs font-medium text-gray-600">Reading:</div>
              <div className="text-xs text-gray-500 mt-1">
                6 practical tips on how
                <br />
                talk to anyone
              </div>
            </div>
              ...
              <div className="w-full md:w-3/4">
                ...
                <div className="flex items-center mb-4">
                  <div className="flex items-center mr-4">
                    <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center mr-2">
                      <Image
                        src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&auto=format&fit=crop&w=40&h=40&q=80"
                        alt="Author"
                        width={40}
                        height={40}
                    ...
                    <span className="text-sm font-medium">REALITY IS NOT WHAT IT SEEMS</span>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gray-50 rounded-lg overflow-hidden border border-gray-200">
                    <div className="h-24 bg-gray-200 relative">
                      <Image
                        src="https://images.unsplash.com/photo-1614728894747-a83421e2b9c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=150&q=80"
                        alt="Unreal Engine"
                        width={300}
                        height={150}
                    ...
                    <div className="p-3">
                      <h3 className="text-sm font-medium">
                        Mobiux Halo games are in development using Unreal Engine 5
                      </h3>
                  ...
                  <div className="bg-gray-50 rounded-lg overflow-hidden border border-gray-200">
                    <div className="h-24 bg-gray-200 relative">
                      <Image
                        src="https://images.unsplash.com/photo-1511512578047-dfb367046420?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=150&q=80"
                        alt="Unreal Engine"
                        width={300}
                        height={150}
                        className="w-full h-full object-cover"
                  ...
                  <div className="flex flex-col mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <h2 className="text-xl font-bold flex items-center">
                        ...
                        Antimony Atom Spin Qudit
                      </h2>
                    </div>
                    <div className="flex flex-wrap text-xs text-gray-500 mt-2 space-x-2">
                ...
                <div className="mt-8 border-t border-gray-200 pt-6">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer flex justify-between items-center">
                      <p className="text-sm">Why is a smile important for first impressions?</p>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer flex justify-between items-center">
                      <p className="text-sm">How can a fake smile be avoided?</p>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-4 w-4 text-gray-400"
                        fill="none"
        ...
        <div className="w-16 bg-white border-l border-gray-200 flex flex-col items-center py-4 space-y-6 hidden lg:flex">
          <button className="p-2 rounded-md hover:bg-gray-100">
            <svg
              xmlns="http://www.w3.org/2000/svg"
