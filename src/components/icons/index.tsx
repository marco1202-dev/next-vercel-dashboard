...
// Collections icon
export const CollectionsIcon = ({ className = "h-5 w-5" }: IconProps) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
// Notification icon
export const NotificationIcon = ({ className = "h-5 w-5" }: IconProps) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
// Document icon
export const DocumentIcon = ({ className = "h-5 w-5" }: IconProps) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
